...
#Составьте булевый вектор из числового, выбрав элеметны большие 10
x<-num_vector>10
x
...
#В домашних матчах (вектор ural_home) Урал забивала в среднем на 0.25 гола каждый матч больше и в сумме 
#на 1 гол больше, чем в выездных. Урал играет в домашних матчах лучше